    ...
    methods
        ...
        function makeRadialAvgNoSeg(this, colimg, colnucmask, colcytmask, colmargin, binWidthMicron, ti, thresh, subBackground)
            ...
            for ri = 1:N
                ...
                % use binary to make it easier later

                colnucbinmask = radialMaskStack{colType}(:,:,ri) & colnucmask;
        ...
        function makeRadialAvgNoMask(this, colimg, colmargin, ti,thresh,subBackground)
            ...
            for ri = 1:N
                ...
                colnucbinmask = radialMaskStack{colType}(:,:,ri);
                colcytbinmask = radialMaskStack{colType}(:,:,ri);
                % we only want to measure if there is something there
                npixTot = sum(sum(radialMaskStack{colType}(:,:,ri)));
